...
# => Help information
usage() {
  echo "Purpose: 安装Xilinx开发工具所支持的下载器驱动"
...
# to install cable drivers is grayed out, with a note to check guide UG973. If
# you own a Xilinx Platform USB cable you will need to manually install them:)
cd ${XILINX_VIVADO}/data/xicom/cable_drivers/lin64/install_script/install_drivers
${sudo_cmd} ./install_drivers
