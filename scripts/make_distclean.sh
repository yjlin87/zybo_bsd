...
if [ -f "${ZN_UBOOT_DIR}/Makefile" ]; then
    make -C ${ZN_UBOOT_DIR} distclean
fi

if [ -f "${ZN_KERNEL_DIR}/Makefile" ]; then
    make -C ${ZN_KERNEL_DIR} distclean
fi

if [ -f "${ZN_BUILDROOT_DIR}/Makefile" ]; then
    make -C ${ZN_BUILDROOT_DIR} distclean
fi
