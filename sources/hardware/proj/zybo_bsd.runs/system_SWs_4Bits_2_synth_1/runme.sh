...
HD_PWD='/mnt/workspace/znsoc/Projects/zybo_bsd/sources/hardware/proj/zybo_bsd.runs/system_SWs_4Bits_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_SWs_4Bits_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_SWs_4Bits_2.tcl
