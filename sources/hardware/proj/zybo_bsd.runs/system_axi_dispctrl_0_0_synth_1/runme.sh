...
HD_PWD='/mnt/workspace/znsoc/Projects/zybo_bsd/sources/hardware/proj/zybo_bsd.runs/system_axi_dispctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_dispctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_dispctrl_0_0.tcl
