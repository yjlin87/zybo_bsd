...
HD_PWD='/mnt/workspace/znsoc/Projects/zybo_bsd/sources/hardware/proj/zybo_bsd.runs/system_rst_ps7_0_150M_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_rst_ps7_0_150M_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_rst_ps7_0_150M_3.tcl
