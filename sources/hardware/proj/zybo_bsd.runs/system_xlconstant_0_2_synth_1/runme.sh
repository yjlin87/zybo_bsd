...
HD_PWD='/mnt/workspace/znsoc/Projects/zybo_bsd/sources/hardware/proj/zybo_bsd.runs/system_xlconstant_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_xlconstant_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_xlconstant_0_2.tcl
