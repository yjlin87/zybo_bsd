...
--               /mnt/workspace/znsoc/Projects/zybo_bsd/sources/hardware/src/bd/system/ip/system_hdmi_tx_0_0/system_hdmi_tx_0_0_sim_netlist.vhdl
...
entity system_hdmi_tx_0_0_SerializerN_1 is
  port (
  ...
  attribute ORIG_REF_NAME of system_hdmi_tx_0_0_SerializerN_1 : entity is "SerializerN_1";
end system_hdmi_tx_0_0_SerializerN_1;

architecture STRUCTURE of system_hdmi_tx_0_0_SerializerN_1 is
  signal I : STD_LOGIC;
  signal \^rst\ : STD_LOGIC;
  signal SHIFTIN1 : STD_LOGIC;
  signal SHIFTIN2 : STD_LOGIC;
  signal \family_7.int_rst_i_1_n_0\ : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_hdmi_tx_0_0_SerializerN_1_2 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_hdmi_tx_0_0_SerializerN_1_2 : entity is "SerializerN_1";
end system_hdmi_tx_0_0_SerializerN_1_2;

architecture STRUCTURE of system_hdmi_tx_0_0_SerializerN_1_2 is
  signal I : STD_LOGIC;
  signal SHIFTIN1 : STD_LOGIC;
  signal SHIFTIN2 : STD_LOGIC;
  signal \NLW_family_7.oserdese2_master_OFB_UNCONNECTED\ : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_hdmi_tx_0_0_SerializerN_1_3 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_hdmi_tx_0_0_SerializerN_1_3 : entity is "SerializerN_1";
end system_hdmi_tx_0_0_SerializerN_1_3;

architecture STRUCTURE of system_hdmi_tx_0_0_SerializerN_1_3 is
  signal I : STD_LOGIC;
  signal SHIFTIN1 : STD_LOGIC;
  signal SHIFTIN2 : STD_LOGIC;
  signal \NLW_family_7.oserdese2_master_OFB_UNCONNECTED\ : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_hdmi_tx_0_0_SerializerN_1_4 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_hdmi_tx_0_0_SerializerN_1_4 : entity is "SerializerN_1";
end system_hdmi_tx_0_0_SerializerN_1_4;

architecture STRUCTURE of system_hdmi_tx_0_0_SerializerN_1_4 is
  signal I : STD_LOGIC;
  signal SHIFTIN1 : STD_LOGIC;
  signal SHIFTIN2 : STD_LOGIC;
  signal \NLW_family_7.oserdese2_master_OFB_UNCONNECTED\ : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_hdmi_tx_0_0_TMDSEncoder is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_hdmi_tx_0_0_TMDSEncoder : entity is "TMDSEncoder";
end system_hdmi_tx_0_0_TMDSEncoder;

architecture STRUCTURE of system_hdmi_tx_0_0_TMDSEncoder is
  ...
  attribute SOFT_HLUTNM of \n1_d[0]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \n1_d[3]_i_3\ : label is "soft_lutpair2";
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_hdmi_tx_0_0_TMDSEncoder_0 is
  port (
    Q : out STD_LOGIC_VECTOR ( 9 downto 0 );
    de_dd : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_hdmi_tx_0_0_TMDSEncoder_0 : entity is "TMDSEncoder";
end system_hdmi_tx_0_0_TMDSEncoder_0;

architecture STRUCTURE of system_hdmi_tx_0_0_TMDSEncoder_0 is
  signal cnt_t : STD_LOGIC_VECTOR ( 4 downto 1 );
  signal cnt_t_1 : STD_LOGIC_VECTOR ( 4 downto 1 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_hdmi_tx_0_0_TMDSEncoder_1 is
  port (
    de_dd : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_hdmi_tx_0_0_TMDSEncoder_1 : entity is "TMDSEncoder";
end system_hdmi_tx_0_0_TMDSEncoder_1;

architecture STRUCTURE of system_hdmi_tx_0_0_TMDSEncoder_1 is
  signal R0 : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_hdmi_tx_0_0_DVITransmitter is
  port (
    HDMI_CLK_P : out STD_LOGIC;
    HDMI_CLK_N : out STD_LOGIC;
    HDMI_D2_P : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_hdmi_tx_0_0_DVITransmitter : entity is "DVITransmitter";
end system_hdmi_tx_0_0_DVITransmitter;

architecture STRUCTURE of system_hdmi_tx_0_0_DVITransmitter is
  signal RST : STD_LOGIC;
  signal de_dd : STD_LOGIC;
...
begin
Inst_TMDSEncoder_blue: entity work.system_hdmi_tx_0_0_TMDSEncoder
     port map (
      PXLCLK_I => PXLCLK_I,
...
Inst_TMDSEncoder_green: entity work.system_hdmi_tx_0_0_TMDSEncoder_0
     port map (
      PXLCLK_I => PXLCLK_I,
...
Inst_TMDSEncoder_red: entity work.system_hdmi_tx_0_0_TMDSEncoder_1
     port map (
      PXLCLK_I => PXLCLK_I,
...
Inst_clk_serializer_10_1: entity work.system_hdmi_tx_0_0_SerializerN_1
     port map (
...
Inst_d0_serializer_10_1: entity work.system_hdmi_tx_0_0_SerializerN_1_2
     port map (
      HDMI_D0_N => HDMI_D0_N,
      HDMI_D0_P => HDMI_D0_P,
      PXLCLK_5X_I => PXLCLK_5X_I,
...
Inst_d1_serializer_10_1: entity work.system_hdmi_tx_0_0_SerializerN_1_3
     port map (
      HDMI_D1_N => HDMI_D1_N,
      HDMI_D1_P => HDMI_D1_P,
      PXLCLK_5X_I => PXLCLK_5X_I,
...
Inst_d2_serializer_10_1: entity work.system_hdmi_tx_0_0_SerializerN_1_4
     port map (
      HDMI_D2_N => HDMI_D2_N,
      HDMI_D2_P => HDMI_D2_P,
      PXLCLK_5X_I => PXLCLK_5X_I,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_hdmi_tx_0_0_hdmi_tx is
  port (
    HDMI_CLK_P : out STD_LOGIC;
    HDMI_CLK_N : out STD_LOGIC;
    HDMI_D2_P : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_hdmi_tx_0_0_hdmi_tx : entity is "hdmi_tx";
end system_hdmi_tx_0_0_hdmi_tx;

architecture STRUCTURE of system_hdmi_tx_0_0_hdmi_tx is
begin
Inst_DVITransmitter: entity work.system_hdmi_tx_0_0_DVITransmitter
     port map (
      HDMI_CLK_N => HDMI_CLK_N,
      HDMI_CLK_P => HDMI_CLK_P,
      HDMI_D0_N => HDMI_D0_N,
...
entity system_hdmi_tx_0_0 is
  ...
  attribute NotValidForBitStream of system_hdmi_tx_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_hdmi_tx_0_0 : entity is "system_hdmi_tx_0_0,hdmi_tx,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of system_hdmi_tx_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of system_hdmi_tx_0_0 : entity is "hdmi_tx,Vivado 2016.4";
end system_hdmi_tx_0_0;

architecture STRUCTURE of system_hdmi_tx_0_0 is
begin
U0: entity work.system_hdmi_tx_0_0_hdmi_tx
     port map (
      HDMI_CLK_N => HDMI_CLK_N,
      HDMI_CLK_P => HDMI_CLK_P,
      HDMI_D0_N => HDMI_D0_N,
